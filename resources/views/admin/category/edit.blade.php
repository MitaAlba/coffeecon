...
<form class="row g-3 needs-validation" novalidate method="POST" action="/admin/categorias/{{$categories->id}}">
  ...
  <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom01" name="name" value="{{$categories->name}}"  required>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="description" value="{{$categories->description}}"  required>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    {{-- <div class="col-md-6">
        ...
        <input type="number" class="form-control" id="validationCustom05" name="total" required>
        <div class="invalid-feedback">
