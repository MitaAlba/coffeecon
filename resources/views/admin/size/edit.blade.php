...
<h1>Admin Sizes EDIT</h1>
<form class="row g-3 needs-validation" novalidate method="POST" action="/admin/medidas/{{$sizes->id}}">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="name" value="{{$sizes->name}}" required>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom03" name="description" value="{{$sizes->description}}" required>
        <div class="invalid-feedback">
    ...
    <div class="col-md-6">
     ...
     <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom05" name="status" value="{{$sizes->status}}" required>
        <div class="invalid-feedback">
            Please provide a valid zip.
        </div>
    </div> 
