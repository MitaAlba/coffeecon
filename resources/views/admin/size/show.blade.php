...
<form class="row g-3 needs-validation" novalidate method="POST" action="/admin/medidas/{{$sizes->id}}">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="name" value="{{$sizes->name}}" disabled>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom03" name="description" value="{{$sizes->description}}" disabled>
        <div class="invalid-feedback">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom05" name="status" value="{{$sizes->status}}" disabled>
        <div class="invalid-feedback">
            Please provide a valid zip.
        </div>
    </div>
