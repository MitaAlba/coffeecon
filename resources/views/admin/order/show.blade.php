...
<form class="row g-3 needs-validation" novalidate method="POST" action="/admin/ordenes/{{$orders->id}}">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom01" name="user_id" value="{{$orders->user_id}}" disabled>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom02" name="store_id" value="{{$orders->store_id}}" disabled>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
    ...
    <div class="col-md-6">
        <label for="validationCustom02" class="form-label">Product_id</label>
        <input type="text" class="form-control" id="validationCustom02" name="product_id" value="{{$orders->product_id}}" disabled>
        <div class="valid-feedback">
            Looks good!
        </div>
    </div>
  ...
  <div class="col-md-6">
    ...
    <input type="number" class="form-control" id="validationCustom02" name="Total" value="{{$orders->total}}" disabled>
    <div class="valid-feedback">
        Looks good!
    </div>
</div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control" id="validationCustom05" name="status" value="{{$orders->status}}" disabled>
        <div class="invalid-feedback">
